...
3.  **Architect Plan:** The high-level task is sent to the Architect model (`gpt-4o`) to create a strategic execution plan.
4.  **Test-Driven Development:** The plan is sent to the Coder model to generate a failing test (`repro_test.py`) that validates the final objective.
